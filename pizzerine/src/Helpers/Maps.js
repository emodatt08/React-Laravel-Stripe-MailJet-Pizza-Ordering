  ...
  render() {
    ...
    if (this.props.center.lat !== undefined) {
      map = (
        <div>
          <div>
          <div> <img  style={{marginLeft: "170px"}} src={`${this.props.order.pizza_type.image}`} alt="pizza-type"/> </div>
          <div className="form-group">
              ...
              <input
                ...
                readOnly="readOnly"
                value={this.props.order.full_name}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={this.onChange}
                readOnly="readOnly"
                value={this.state.city +', '+this.state.area+', '+this.state.state+' + ---- + '+this.state.address}
              />
            </div>
